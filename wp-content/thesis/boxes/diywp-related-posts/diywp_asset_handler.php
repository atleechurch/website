<?php
/*
Name: DIYWPBlog Media Asset Handler
Author: Matthew Horne
Version: 1.2
Configuration:
Change $from (ln 54) to point to your update file, see update.php for example
Change the 'diywp' prefix on the class name (ln 12) and the diywp_callout transient (ln 22 & 23) to your own
Rename the file to match your class name
*/

class diywp_asset_handler {
      ...
      public function get_all_updates() {
            ...
            //delete_transient('diywp_callout'); //uncommenting this line will force an update check, for testing purposes only
            if (get_transient('diywp_callout'))
            return;

            set_transient('diywp_callout', time(), 60*60*24);
            ...
            $from = 'http://diywpblog.com/boxupdate/update.php';
            $post_args = array(
               'body' => array(
               'data' => serialize($all),
