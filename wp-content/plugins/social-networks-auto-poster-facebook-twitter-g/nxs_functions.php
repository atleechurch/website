...
//## V4 Future
 ...
 function nxs_showNTFilters($nt, $ii, $options){ if (empty($options['fltrs'])) $options['fltrs'] = ''; $isFOn = !empty($options['fltrsOn']) && (int)$options['fltrsOn'] == 1; ?> <h3 style="padding-left: 0px;font-size: 16px;">
...
function nxs_addPostingDelaySelV4($nt, $ii, $options) { if (!isset($options['nHrs'])) $options['nHrs'] = ''; if (!isset($options['nMin'])) $options['nMin'] = ''; if (!isset($options['nDays'])) $options['nDays'] = '';
